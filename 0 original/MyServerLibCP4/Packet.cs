...
namespace MyServerLibCP4
{
    public class Packet
    {
        ...
        public Packet(byte[] buffer, int startpos, int len)
        {
            ...
            Array.Copy(buffer, startpos, _Buffer, 0, len);
            PacketLen = len;
        }
        ...
        {            
            BitConverter.GetBytes(data).CopyTo(_Buffer, offset);
        }
        ...
        {
            Array.Copy(buffer, 0, _Buffer, BufferPos, len);
            BufferPos += len;
            PacketLen = BufferPos;
        }
        ...
        {
            uint read = BitConverter.ToUInt32(_Buffer, BufferPos);
        ...
        {
            ushort read = BitConverter.ToUInt16(_Buffer, BufferPos);
        ...
        {
            double read = BitConverter.ToDouble(_Buffer, BufferPos);
        ...
        {
            float read = BitConverter.ToSingle(_Buffer, BufferPos);
        ...
        {
            char read = BitConverter.ToChar(_Buffer, BufferPos);
        ...
        {
            bool read = BitConverter.ToBoolean(_Buffer, BufferPos);
        ...
        {
            short read = BitConverter.ToInt16(_Buffer, BufferPos);
        ...
        {
            long read = BitConverter.ToInt64(_Buffer, BufferPos);
        ...
        public int ReadInt()
        {
            int read = BitConverter.ToInt32(_Buffer, BufferPos);
        ...
        public string ReadString()
        {
            ...
            string s = System.Text.Encoding.Unicode.GetString(_Buffer, BufferPos, Count);
            BufferPos += Count;
            return s;
        }
